...
public:
     ...
     int fontPixelSizeSmall;
     int fontPixelSizeLarge;
     QString fontstyle;
public:
	QZint();
	~QZint();
    ...
    //void setaspectRatio(Zint::QZint::AspectRatioMode ratio);
    ...
    void setfontPixelSizeSmall(int sizeSmall);
    void setfontPixelSizeLarge(int sizeLarge);

    void setfontType(QString fontType);

    void setforegroundColor(QColor ColorFg);
