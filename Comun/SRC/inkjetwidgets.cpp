...
InkjetFrame::InkjetFrame(QWidget *parent)
    : QWidget(parent)
...
#ifdef QT_OPENGL_SUPPORT
void InkjetFrame::enableOpenGL(bool use_opengl)
{
...
void InkjetFrame::paintEvent(QPaintEvent *e)
{
...
void InkjetFrame::resizeEvent(QResizeEvent *e)
{
#ifdef QT_OPENGL_SUPPORT
    if (glw)
...
void InkjetFrame::setDescriptionEnabled(bool enabled)
{
...
void InkjetFrame::loadDescription(const QString &fileName)
{
...
void InkjetFrame::setDescription(const QString &text)
{
    m_document = new QTextDocument(this);
    m_document->setHtml(text);
}

void InkjetFrame::paintDescription(QPainter *painter)
{
    if (!m_document)
        return;
...
void InkjetFrame::loadSourceFile(const QString &sourceFile)
{
    m_sourceFileName = sourceFile;
}

void InkjetFrame::showSource()
{
